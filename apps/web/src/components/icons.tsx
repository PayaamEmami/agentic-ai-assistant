...
export function ChevronDownIcon({
  ...
  className,
  ...props
}: IconProps & { animated?: boolean; collapsed?: boolean }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={cn('shrink-0 text-foreground-muted', animated && 'transition-transform', collapsed && 'rotate-90', className)} aria-hidden="true" {...props}>
      <path d="m6 9 6 6 6-6" />
    </svg>
  );
}
